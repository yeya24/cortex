...
func (i *icebucket) IterWithAttributes(ctx context.Context, dir string, f func(objstore.IterObjectAttributes) error, options ...objstore.IterOption) error {
	return i.bucket.IterWithAttributes(ctx, strings.TrimPrefix(dir, i.prefix), f, options...)
}

func (i *icebucket) SupportedIterOptions() []objstore.IterOptionType {
	return i.bucket.SupportedIterOptions()
}
