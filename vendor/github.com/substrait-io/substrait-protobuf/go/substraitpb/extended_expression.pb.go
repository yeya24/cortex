...
var file_substrait_extended_expression_proto_rawDesc = []byte{
	...
	0x65, 0x55, 0x72, 0x6c, 0x73, 0x42, 0xa7, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x75,
	0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0x42, 0x17, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x65,
	0x64, 0x45, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x74, 0x72, 0x61, 0x69, 0x74, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x67,
	0x6f, 0x2f, 0x73, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0x70, 0x62, 0xa2, 0x02, 0x03,
	0x53, 0x58, 0x58, 0xaa, 0x02, 0x09, 0x53, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0xca,
	0x02, 0x09, 0x53, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0xe2, 0x02, 0x15, 0x53, 0x75,
	0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0xea, 0x02, 0x09, 0x53, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x69, 0x74, 0x62,
...
var file_substrait_extended_expression_proto_goTypes = []interface{}{
...
func file_substrait_extended_expression_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_substrait_extended_expression_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExpressionReference); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_substrait_extended_expression_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtendedExpression); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_substrait_extended_expression_proto_msgTypes[0].OneofWrappers = []interface{}{
